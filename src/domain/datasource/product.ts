...
import type { SearchProductReq } from "../dto/product/request/SearchProductReq";
...
import type { SearchProductRes } from "../dto/product/response/SearchProductRes";
import type { UpdateProductRes } from "../dto/product/response/UpdateProductRes";

export abstract class ProductDataSourceI {
    ...
    abstract search(dto: SearchProductReq): Promise<SearchProductRes>;
